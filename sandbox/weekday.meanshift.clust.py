...
def weekhour(lst,day,hour):
    ...
    ms = MeanShift(bandwidth=.001, bin_seeding=True)
    ms.fit(l)
    labels = ms.labels_
    ...
    import geocoder
    g = geocoder.google(list_clust_cents[0], method='reverse')
    address = g.address
    ...
    'number_of_estimated_clusters', 'address', 'coordinate']
        ...
        mondaywriter.writeheader()
        mondaywriter.writerow({'day': day, 'hour': hour, \
                           'densest_cluster': densest, \
                           'number_of_samples': num_samples, \
                           'number_of_estimated_clusters': n_clusters_, \
                           'address': address, \
                           'coordinate': list_clust_cents[1]})
...
# carries out weekhour function for all day by hours

weekhour(lst=mon00,day=0,hour=0)
weekhour(lst=mon01,day=0,hour=1)
weekhour(lst=mon02,day=0,hour=2)
weekhour(lst=mon03,day=0,hour=3)
weekhour(lst=mon04,day=0,hour=4)
weekhour(lst=mon05,day=0,hour=5)
weekhour(lst=mon06,day=0,hour=6)
weekhour(lst=mon07,day=0,hour=7)
weekhour(lst=mon08,day=0,hour=8)
weekhour(lst=mon09,day=0,hour=9)
weekhour(lst=mon10,day=0,hour=10)
weekhour(lst=mon11,day=0,hour=11)
weekhour(lst=mon12,day=0,hour=12)
weekhour(lst=mon13,day=0,hour=13)
weekhour(lst=mon14,day=0,hour=14)
weekhour(lst=mon15,day=0,hour=15)
weekhour(lst=mon16,day=0,hour=16)
weekhour(lst=mon17,day=0,hour=17)
weekhour(lst=mon18,day=0,hour=18)
weekhour(lst=mon19,day=0,hour=19)
weekhour(lst=mon20,day=0,hour=20)
weekhour(lst=mon21,day=0,hour=21)
weekhour(lst=mon22,day=0,hour=22)
weekhour(lst=mon23,day=0,hour=23)
weekhour(lst=tues00,day=1,hour=0)
weekhour(lst=tues01,day=1,hour=1)
weekhour(lst=tues02,day=1,hour=2)
weekhour(lst=tues03,day=1,hour=3)
weekhour(lst=tues04,day=1,hour=4)
weekhour(lst=tues05,day=1,hour=5)
weekhour(lst=tues06,day=1,hour=6)
weekhour(lst=tues07,day=1,hour=7)
weekhour(lst=tues08,day=1,hour=8)
weekhour(lst=tues09,day=1,hour=9)
weekhour(lst=tues10,day=1,hour=10)
weekhour(lst=tues11,day=1,hour=11)
weekhour(lst=tues12,day=1,hour=12)
weekhour(lst=tues13,day=1,hour=13)
weekhour(lst=tues14,day=1,hour=14)
weekhour(lst=tues15,day=1,hour=15)
weekhour(lst=tues16,day=1,hour=16)
weekhour(lst=tues17,day=1,hour=17)
weekhour(lst=tues18,day=1,hour=18)
weekhour(lst=tues19,day=1,hour=19)
weekhour(lst=tues20,day=1,hour=20)
weekhour(lst=tues21,day=1,hour=21)
weekhour(lst=tues22,day=1,hour=22)
weekhour(lst=tues23,day=1,hour=23)
weekhour(lst=wed00,day=2,hour=0)
weekhour(lst=wed01,day=2,hour=1)
weekhour(lst=wed02,day=2,hour=2)
weekhour(lst=wed03,day=2,hour=3)
weekhour(lst=wed04,day=2,hour=4)
weekhour(lst=wed05,day=2,hour=5)
weekhour(lst=wed06,day=2,hour=6)
weekhour(lst=wed07,day=2,hour=7)
weekhour(lst=wed08,day=2,hour=8)
weekhour(lst=wed09,day=2,hour=9)
weekhour(lst=wed10,day=2,hour=10)
weekhour(lst=wed11,day=2,hour=11)
weekhour(lst=wed12,day=2,hour=12)
weekhour(lst=wed13,day=2,hour=13)
weekhour(lst=wed14,day=2,hour=14)
weekhour(lst=wed15,day=2,hour=15)
weekhour(lst=wed16,day=2,hour=16)
weekhour(lst=wed17,day=2,hour=17)
weekhour(lst=wed18,day=2,hour=18)
weekhour(lst=wed19,day=2,hour=19)
weekhour(lst=wed20,day=2,hour=20)
weekhour(lst=wed21,day=2,hour=21)
weekhour(lst=wed22,day=2,hour=22)
weekhour(lst=wed23,day=2,hour=23)
weekhour(lst=thurs00,day=3,hour=0)
weekhour(lst=thurs01,day=3,hour=1)
weekhour(lst=thurs02,day=3,hour=2)
weekhour(lst=thurs03,day=3,hour=3)
weekhour(lst=thurs04,day=3,hour=4)
weekhour(lst=thurs05,day=3,hour=5)
weekhour(lst=thurs06,day=3,hour=6)
weekhour(lst=thurs07,day=3,hour=7)
weekhour(lst=thurs08,day=3,hour=8)
weekhour(lst=thurs09,day=3,hour=9)
weekhour(lst=thurs10,day=3,hour=10)
weekhour(lst=thurs11,day=3,hour=11)
weekhour(lst=thurs12,day=3,hour=12)
weekhour(lst=thurs13,day=3,hour=13)
weekhour(lst=thurs14,day=3,hour=14)
weekhour(lst=thurs15,day=3,hour=15)
weekhour(lst=thurs16,day=3,hour=16)
weekhour(lst=thurs17,day=3,hour=17)
weekhour(lst=thurs18,day=3,hour=18)
weekhour(lst=thurs19,day=3,hour=19)
weekhour(lst=thurs20,day=3,hour=20)
weekhour(lst=thurs21,day=3,hour=21)
weekhour(lst=thurs22,day=3,hour=22)
weekhour(lst=thurs23,day=3,hour=23)
weekhour(lst=fri00,day=4,hour=0)
weekhour(lst=fri01,day=4,hour=1)
weekhour(lst=fri02,day=4,hour=2)
weekhour(lst=fri03,day=4,hour=3)
weekhour(lst=fri04,day=4,hour=4)
weekhour(lst=fri05,day=4,hour=5)
weekhour(lst=fri06,day=4,hour=6)
weekhour(lst=fri07,day=4,hour=7)
weekhour(lst=fri08,day=4,hour=8)
weekhour(lst=fri09,day=4,hour=9)
weekhour(lst=fri10,day=4,hour=10)
weekhour(lst=fri11,day=4,hour=11)
weekhour(lst=fri12,day=4,hour=12)
weekhour(lst=fri13,day=4,hour=13)
weekhour(lst=fri14,day=4,hour=14)
weekhour(lst=fri15,day=4,hour=15)
weekhour(lst=fri16,day=4,hour=16)
weekhour(lst=fri17,day=4,hour=17)
weekhour(lst=fri18,day=4,hour=18)
weekhour(lst=fri19,day=4,hour=19)
weekhour(lst=fri20,day=4,hour=20)
weekhour(lst=fri21,day=4,hour=21)
weekhour(lst=fri22,day=4,hour=22)
weekhour(lst=fri23,day=4,hour=23)
weekhour(lst=sat00,day=5,hour=0)
weekhour(lst=sat01,day=5,hour=1)
weekhour(lst=sat02,day=5,hour=2)
weekhour(lst=sat03,day=5,hour=3)
weekhour(lst=sat04,day=5,hour=4)
weekhour(lst=sat05,day=5,hour=5)
weekhour(lst=sat06,day=5,hour=6)
weekhour(lst=sat07,day=5,hour=7)
weekhour(lst=sat08,day=5,hour=8)
weekhour(lst=sat09,day=5,hour=9)
weekhour(lst=sat10,day=5,hour=10)
weekhour(lst=sat11,day=5,hour=11)
weekhour(lst=sat12,day=5,hour=12)
weekhour(lst=sat13,day=5,hour=13)
weekhour(lst=sat14,day=5,hour=14)
weekhour(lst=sat15,day=5,hour=15)
weekhour(lst=sat16,day=5,hour=16)
weekhour(lst=sat17,day=5,hour=17)
weekhour(lst=sat18,day=5,hour=18)
weekhour(lst=sat19,day=5,hour=19)
weekhour(lst=sat20,day=5,hour=20)
weekhour(lst=sat21,day=5,hour=21)
weekhour(lst=sat22,day=5,hour=22)
weekhour(lst=sat23,day=5,hour=23)
weekhour(lst=sun00,day=6,hour=0)
weekhour(lst=sun01,day=6,hour=1)
weekhour(lst=sun02,day=6,hour=2)
weekhour(lst=sun03,day=6,hour=3)
weekhour(lst=sun04,day=6,hour=4)
weekhour(lst=sun05,day=6,hour=5)
weekhour(lst=sun06,day=6,hour=6)
weekhour(lst=sun07,day=6,hour=7)
weekhour(lst=sun08,day=6,hour=8)
weekhour(lst=sun09,day=6,hour=9)
weekhour(lst=sun10,day=6,hour=10)
weekhour(lst=sun11,day=6,hour=11)
weekhour(lst=sun12,day=6,hour=12)
weekhour(lst=sun13,day=6,hour=13)
weekhour(lst=sun14,day=6,hour=14)
weekhour(lst=sun15,day=6,hour=15)
weekhour(lst=sun16,day=6,hour=16)
weekhour(lst=sun17,day=6,hour=17)
weekhour(lst=sun18,day=6,hour=18)
weekhour(lst=sun19,day=6,hour=19)
weekhour(lst=sun20,day=6,hour=20)
weekhour(lst=sun21,day=6,hour=21)
weekhour(lst=sun22,day=6,hour=22)
weekhour(lst=sun23,day=6,hour=23)
